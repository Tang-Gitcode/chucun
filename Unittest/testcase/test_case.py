...
import time
import unittest
from Unittest.PageObject.login_page import LoginPage
...
class TestCase(unittest.TestCase):
    ...
    def test_goods(self):
        ...
        # 上传6张图片，遍历上传操作6次
        for num in range(6):
            driver.find_element(By.NAME, "file").send_keys(f'C:/Users/administered/Desktop/缺陷图片/11.25/'+str(num+1)
                                                           + '.png')
            time.sleep(0.5)
            if num > 6:
                break
        ...
        """编辑商品详情"""
        driver.find_element(By.XPATH, '//div[@class="img_con"]/following::input')\
        ...
        time.sleep(3)
        # 添加图片
        driver.find_element(By.XPATH, '//div[@class="img_con"]/following::input[5]').send_keys(
            f'C:/Users/administered/Desktop/缺陷图片/11.25/1.png')
        time.sleep(5)
