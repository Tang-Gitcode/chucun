...
class Application(Frame):
    ...
    def createWidget(self):
        ...
        btn_start.pack(sid="left", padx="10")
        btn_pen = Button(root, text="画笔", name="pen")
        btn_pen.pack(sid="left", padx="10")
        btn_rect = Button(root, text="矩形", name="rect")
        btn_rect.pack(sid="left", padx="10")
        btn_clear = Button(root, text="清屏", name="clear")
        btn_clear.pack(sid="left", padx="10")
        btn_erasor = Button(root, text="橡皮擦", name="erasor")
        btn_erasor.pack(sid="left", padx="10")
        btn_line = Button(root, text="直线", name="line")
        btn_line.pack(sid="left", padx="10")
        btn_lineArrow = Button(root, text="箭头直线", name="lineArrow")
        btn_lineArrow.pack(sid="left", padx="10")
        btn_color = Button(root, text="颜色", name="color")
        btn_color.pack(sid="left", padx="10")
